...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CAJF3NN4J6ZPNKMM3YQKU6JLEWE5ONWU4OSMAOCGQ4HWGLE65BWZPAUL";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        end_match: (json: string) => AssembledTransaction<null>;
        start_match: (json: string) => AssembledTransaction<null>;
        submit_move: (json: string) => AssembledTransaction<null>;
    };
}
